...
# S9 · Guardrails: lee el ID y versión del guardrail desde env vars
...
def lambda_handler(event, context):
    ...
    try:
        ...
        # S9 · Guardrails: arma los parámetros base
        kwargs = {
        ...
        # S9 · Guardrails: si está configurado, agrega guardrailConfig
        if GUARDRAIL_ID:
            kwargs["guardrailConfig"] = {
                "guardrailIdentifier": GUARDRAIL_ID,
                "guardrailVersion": GUARDRAIL_VER,
            }
        # Llama a Bedrock con o sin guardrail
